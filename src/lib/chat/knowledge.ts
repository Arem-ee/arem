...
export const qaPairs: QAPair[] = [
  {
    ...
    answer:
      "I'm Arem, short for Toromade Abdulrahman. I'm a fullstack developer and AI engineer based in Nigeria, currently studying electrical engineering at the University of Ilorin. I build products end to end, from architecture to shipped code, and I also write about self-custody and DAO tooling.",
  },
  {
    id: "build",
    questions: [
